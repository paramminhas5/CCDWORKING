...
// ── Countdown ─────────────────────────────────────────────────────────────────
const NEXT_SHOW_DATE = new Date("2026-06-26T10:30:00Z"); // 4 PM IST
...
const STOPS = [
  {
    ...
    date: "Fri, 26 Jun 2026 · 4 PM till late", tagline: "The first show · where it all begins",
...
const jsonLd = {
  ...
  subEvent: [
    { "@type": "Event", name: "CCD × SOCIAL — Bangalore", startDate: "2026-06-26", location: { "@type": "Place", name: "Social, Indiranagar", address: "Bengaluru, IN" } },
  ...
  return (
    <>
      ...
      <main className="bg-cream text-ink relative">
              ...
              <div className="mt-6 flex flex-wrap items-end gap-3">
                {cd && !cd.over && (
                  <div className="bg-ink text-cream border-4 border-ink chunk-shadow px-4 py-3">
                    ...
                    <div className="font-display text-[10px] mt-2 text-cream/70">FRI 26 JUN · SOCIAL INDIRANAGAR · 4 PM</div>
                  </div>
                )}
        ...
        {/* ── MARQUEE ── */}
        <Marquee bg="bg-acid-yellow" items={["CCD × SOCIAL", "BANGALORE 26 JUN", "BOMBAY JULY", "HYDERABAD AUGUST", "DELHI OCTOBER", "FREE ENTRY · RSVP"]} />
