...
const POSTER_URL = "https://catscandance.com/__l5e/assets-v1/4ec50939-9498-4ff9-b642-2a095db54775/ccdxsocial-blr-poster.jpg";
      ...
      <main className="bg-background text-foreground">
        ...
        <section className="bg-ink border-b-4 border-ink py-12 md:py-16">
          <div className="container flex flex-col items-center text-center">
            <p className="font-display text-acid-yellow text-xs uppercase tracking-[0.3em] mb-4">▶ NEXT EVENT</p>
            <div className="w-full max-w-md mx-auto mb-6">
              <img src={POSTER_URL} alt="CCD×SOCIAL — Sun 28 Jun, Social Indiranagar" className="w-full h-auto border-4 border-cream/20" />
            </div>
            <h2 className="font-display text-cream text-3xl md:text-5xl mb-3">CCD × SOCIAL 01</h2>
            <p className="font-display text-cream/70 text-lg mb-6">Sun 28 Jun · Social, Indiranagar · Free RSVP</p>
            <a href="/events/ccdxsocial-blr" className="bg-acid-yellow text-ink font-display text-lg px-8 py-3 border-4 border-ink chunk-shadow hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-transform">
              RSVP NOW — IT'S FREE →
            </a>
          </div>
        </section>
